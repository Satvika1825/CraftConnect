...
export default function Cart() {
  ...
  useEffect(() => {
    const fetchCartItems = async () => {
      ...
      try {
        ...
        const cartResponse = await axios.get(`https://craftconnect-bbdp.onrender.com/cart-api/cart/${userResponse.data._id}`);
  ...
  const handleUpdateQuantity = async (itemId: string, newQuantity: number) => {
    try {
      await axios.put(`https://craftconnect-bbdp.onrender.com/cart-api/cart/${itemId}`, {
  ...
  const handleRemoveItem = async (itemId: string) => {
    try {
      await axios.delete(`https://craftconnect-bbdp.onrender.com/cart-api/cart/${itemId}`);
...
const handleCheckout = async () => {
  ...
  try {
    ...
    // Create order
    const orderResponse = await axios.post('https://craftconnect-bbdp.onrender.com/order-api/orders/create', {
    ...
    if (orderResponse.data) {
      ...
      await Promise.all(cartItems.map(item => 
        axios.delete(`https://craftconnect-bbdp.onrender.com/cart-api/cart/${item._id}`)
      ));
